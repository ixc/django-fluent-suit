...
setuptools.setup(
    name='django-fluent-suit',
    use_scm_version={'version_scheme': 'post-release'},
    author='Interaction Consortium',
    author_email='studio@interaction.net.au',
    url='https://github.com/ixc/django-fluent-suit',
    description='Fluent CMS and Django Suit integration.',
    long_description=locals().get('long_description', ''),
    # license='MIT',
    packages=setuptools.find_packages(),
    include_package_data=True,
    install_requires=[
        'django-suit',  # Fluent CMS components are all optional
    ],
